...
const AuthLayout = ({ pageImage, authTitle, helpText, children }: AccountLayoutProps) => {
	return (
		<>
						...
						<div className="card overflow-hidden">
							<div className="p-9 bg-primary">
								<Link to="/" className="flex justify-center">
									<img src={logo} alt="logo" className="h-9 block dark:hidden" />
							...
							<div className="p-9">
								<div className="text-center mx-auto w-3/4">
									...
									<p className="text-gray-400 mb-4">{helpText}</p>
								</div>
			...
			<footer className="absolute bottom-0 inset-x-0">
				<p className="font-medium text-center p-6">{new Date().getFullYear()} © SIMADU - Sistem Informasi Madrasah Terpadu</p>
			</footer>
		</>
	)
}
